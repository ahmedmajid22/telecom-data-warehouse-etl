...
import logging
import os
import time  # 🚀 ADDED: Required for sleeping between retries
from sqlalchemy import create_engine, Table, MetaData, text
# 🚀 ADDED: To catch connection errors
...
def get_engine():
    ...
    # 🚀 UPDATED: Retry logic added to wait for DB to be ready
...
def get_max_transaction_date(engine):
    ...
    try:
        ...
        logging.warning(
            f"Could not fetch max date/id (table likely empty). Proceeding with full load.")
        return None, None
